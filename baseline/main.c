...
int main() {
    int width = 320;
    int height = 240;
    unsigned char *current_frame = read_image_from_text("current_frame.txt", width, height);
    unsigned char *reference_frame = read_image_from_text("reference_frame.txt", width, height);
